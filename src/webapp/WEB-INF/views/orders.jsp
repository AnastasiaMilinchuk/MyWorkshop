...
<div class="container-fluid text-center">
    ...
    <div class="col-sm-8 text-left main">
        ...
        <div class="new-order-block">
            ...
            <a href='/MyWorkshop/repair-order'><button type="button" class="btn btn-danger"><spring:message code="order.newOrder"/></button></a>
            </div>
            <div class="search">
                    <div class="col-xs-4">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th><spring:message code="order.employee"/></th>
                <th><spring:message code="order.entity"/></th>
